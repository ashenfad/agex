...
class ValueRenderer:
    ...
    def render(self, value: Any, current_depth: int = 0) -> str:
        ...
        if isinstance(value, AgexObject):
            return self._render_agex_instance_or_object(value, current_depth)
    ...
    def _render_agex_instance_or_object(self, value: Any, depth: int) -> str:
        items = []
    ...
    def _render_dataclass(self, value: Any, depth: int) -> str:
        ...
        for f in fields(value):
            ...
            rendered_value = self.render(field_value, depth + 1)
